...
- Runnable CLI trap fixtures for severe QQ tail departure (`REVIEW`), missing QQ reference lines (`BLOCK`), obvious residual structure (`REVIEW`), and tiny diagnostic samples (`BLOCK`).
