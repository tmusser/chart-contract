...
AUDIT_V0_2 = ProfileManifest(
    ...
    rules=(
        ...
        _r("data.set_membership.member_unique", ("chart",), ("PASS", "FAIL"), "Set-membership member identifiers must be non-null, non-empty, and unique.", "Uniqueness does not prove entity resolution correctness."),
        ...
        _r("data.process_tree.columns", ("chart",), ("PASS", "FAIL"), "Process-tree audits require declared node, parent, label, and optional branch columns to exist.", "Column presence does not prove the documented process is complete or correct."),
        _r("data.process_tree.node_unique", ("chart",), ("PASS", "FAIL"), "Process-tree node identifiers must be non-null, non-empty, and unique.", "Identifier uniqueness does not prove node identity is semantically correct."),
        _r("data.process_tree.labels", ("chart",), ("PASS", "FAIL"), "Every process-tree node requires a non-empty display label.", "Readable labels do not prove process semantics are accurate."),
        _r("data.process_tree.root", ("chart",), ("PASS", "FAIL"), "A process tree must contain exactly one root node with no parent.", "A single root establishes topology only, not whether the process should have one conceptual entry point."),
        _r("data.process_tree.parent_reference", ("chart",), ("PASS", "FAIL"), "Every non-root parent reference must resolve to an existing node identifier.", "Reference integrity does not establish that the parent-child relationship is substantively correct."),
        _r("data.process_tree.acyclic", ("chart",), ("PASS", "FAIL"), "Process-tree parent relationships must be acyclic and reachable from the root.", "Acyclic structure does not prove the real process contains no loops or retries."),
        _r("visual.process_tree.structure", ("chart",), ("PASS",), "The first-party renderer preserves rooted topology, edge direction, and optional branch labels.", "The layout is schematic and does not encode duration, probability, importance, or causal strength."),
