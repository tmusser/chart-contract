...
AUDIT_V0_2 = ProfileManifest(
    ...
    rules=(
        ...
        _r("data.process_tree.node_unique", ("chart",), ("PASS", "FAIL"), "Process-tree node identifiers must be non-null and unique.", "Identifier uniqueness does not prove node identity is semantically correct."),
